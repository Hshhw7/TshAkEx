...
Namebot = (database:get(bot_id.."Tshake:Name:Bot") or "فايرس")
ArrayRdods = {
"تراك ازعجتنا",
...
※ بيع مجوهراتي ← { العدد } ← لبيع كل نقطه مقابل {50} رساله
]]
...
🚩┇[ VIRUS SOURCE ]
 ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ 
📥┇[ YouTube downloader ](t.me/QRD_bot)

🔰┇[ CHANNEL SOURCE ](t.me/PHP_STORE_EG)

📂┇[ CODER ](t.me/FLASH_MASR)
 ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ 
]]
send(msg.chat_id_, msg.id_,Text)
end
...
keyboard.inline_keyboard = {
{
{text = '1', callback_data=msg.sender_user_id_.."/help1"},{text = '2', callback_data=msg.sender_user_id_.."/help2"},{text = '3', callback_data=msg.sender_user_id_.."/help3"},
},
{
{text = '4', callback_data=msg.sender_user_id_.."/help4"},
},
{
{text = '5', callback_data=msg.sender_user_id_.."/help5"},
},
{
...
keyboard.inline_keyboard = {
{
{text = '1', callback_data=data.sender_user_id_.."/help1"},{text = '2', callback_data=data.sender_user_id_.."/help2"},{text = '3', callback_data=data.sender_user_id_.."/help3"},
},
{
{text = '4', callback_data=data.sender_user_id_.."/help4"},
},
{
{text = '5', callback_data=data.sender_user_id_.."/help5"},
},
{
...
local Name_Bot = (database:get(bot_id.."Tshake:Name:Bot") or "فايرس")
